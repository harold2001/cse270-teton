...
class TestSmokeTest():
  ...
  def test_1Navigatetothehomepage(self):
    ...
    self.driver.set_window_size(1340, 1095)
  ...
  def test_2Navigatetothehomepage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1337, 1209)
  ...
  def test_3Navigatetothedirectorypage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1351, 1256)
  ...
  def test_5Navigatetotheadminpage(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1366, 1285)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("adminasd")
    self.driver.find_element(By.ID, "password").send_keys("adminqwe")
